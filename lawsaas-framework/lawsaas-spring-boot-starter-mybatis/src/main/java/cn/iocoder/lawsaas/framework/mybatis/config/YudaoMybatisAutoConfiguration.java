package cn.iocoder.lawsaas.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.iocoder.lawsaas.framework.common.util.json.JsonUtils;
import cn.iocoder.lawsaas.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${lawsaas.info.base-package}", annotationClass = Mapper.class,
