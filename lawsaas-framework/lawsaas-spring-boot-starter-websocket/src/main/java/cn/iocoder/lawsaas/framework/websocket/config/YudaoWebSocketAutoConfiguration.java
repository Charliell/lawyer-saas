package cn.iocoder.lawsaas.framework.websocket.config;

import cn.iocoder.lawsaas.framework.mq.redis.core.RedisMQTemplate;
import cn.iocoder.lawsaas.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.iocoder.lawsaas.framework.websocket.core.listener.WebSocketMessageListener;
import cn.iocoder.lawsaas.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.iocoder.lawsaas.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.iocoder.lawsaas.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.iocoder.lawsaas.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.iocoder.lawsaas.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.iocoder.lawsaas.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.iocoder.lawsaas.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.iocoder.lawsaas.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.iocoder.lawsaas.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.iocoder.lawsaas.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.iocoder.lawsaas.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.iocoder.lawsaas.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.iocoder.lawsaas.framework.websocket.core.session.WebSocketSessionManager;
import cn.iocoder.lawsaas.framework.websocket.core.session.WebSocketSessionManagerImpl;
import cn.iocoder.lawsaas.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
