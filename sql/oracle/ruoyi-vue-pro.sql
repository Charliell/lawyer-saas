...
INSERT INTO infra_file_config (id, name, storage, remark, master, config, creator, create_time, updater, update_time, deleted) VALUES (26, '火山云存储（示例）', 20, '', '0', '{"@class":"cn.iocoder.yudao.module.infra.framework.file.core.client.s3.S3FileClientConfig","endpoint":"tos-s3-cn-beijing.volces.com","domain":null,"bucket":"yunai","accessKey":"your-volcengine-access-key-id","accessSecret":"X==","enablePathStyleAccess":false}', '1', to_date('2024-11-09 16:56:42', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2025-05-02 18:30:28', 'SYYYY-MM-DD HH24:MI:SS'), '0');
